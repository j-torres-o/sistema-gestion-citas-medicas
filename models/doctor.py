...
class Doctor(EntidadBase):
    ...
    def __init__(self, id_medico=None, numero_licencia=None, nombre_completo=None, 
    ...
    def _get_campos_valores(self):
        campos = ['numero_licencia', 'nombre_completo', 'id_especialidad', 'duracion_defecto']
        valores = [self.numero_licencia, self.nombre_completo, self.id_especialidad, self.duracion_defecto]
